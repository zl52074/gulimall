package com.zl52074.gulimall.product.utils;
...
public class RedisUtil {
    ...
    public Object bLPop(int timeout,String key){
        try{
            return redisTemplate.getConnectionFactory().getConnection().bLPop(timeout, key.getBytes());
        }catch (Exception e){
            e.printStackTrace();
            return null;
        }
    ...
    public List<byte[]> bRPop(int timeout,String key){
        try{
            return redisTemplate.getConnectionFactory().getConnection().bRPop(timeout, key.getBytes("UTF-8"));
        }catch (Exception e){
            e.printStackTrace();
            return null;
        }
    ...
    public boolean hmSetIfAbsent(String key, String hashKey, Object value){
        try{
    ...
    public long hmdel(String key, String...hashKeys){
        try{
    ...
    /**
     * HashMap 判断是否在key的HashMap集合中包含有hashKey这个key
     * @param key
     * @param hashKey
     * @return
     */
    public boolean hmHasHashKey(String key, String hashKey){
        try{
    ...
    public boolean hset(String key, String hk,String hv){
        try {
...
//                    operations.multi();
//                    operations.opsForHash().putIfAbsent(key, hk,hv);
...
//            return redisTemplate.execute(sessionCallback);
    ...
    /**
     * @// TODO: 2021/5/7  根据key 查询set 所有的元素集合
     * @param key
     * @return
     */
