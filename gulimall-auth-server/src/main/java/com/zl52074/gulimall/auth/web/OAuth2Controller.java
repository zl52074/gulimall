...
public class OAuth2Controller {
    ...
    public String weibo(@RequestParam("code") String code, HttpSession session) throws Exception {
        ...
        // map.put("code",code);
        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl("https://api.weibo.com/oauth2/access_token")
                .queryParam("client_id", "163046780")
                .queryParam("client_secret", "ae3d2c831588a5856d6b0fa0a5af1879")
                .queryParam("grant_type", "authorization_code")
                .queryParam("redirect_uri", "http://auth.gulimall.com/oauth2.0/weibo/success")
                .queryParam("code", code);
        RestTemplate restTemplate = new RestTemplate();
        ResponseEntity<SocialUser> response = restTemplate.exchange(builder.build().toUri(), HttpMethod.POST, null, SocialUser.class);
