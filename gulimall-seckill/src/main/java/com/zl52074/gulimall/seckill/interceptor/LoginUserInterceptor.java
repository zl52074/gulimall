package com.zl52074.gulimall.seckill.interceptor;
...
public class LoginUserInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        boolean match = antPathMatcher.match("/getCurrentSeckillSkus", uri);
        boolean match1 = antPathMatcher.match("/sku/seckill/**", uri);
        if (match||match1) {
            return true;
        }
