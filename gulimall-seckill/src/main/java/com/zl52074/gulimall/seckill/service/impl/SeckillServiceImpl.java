package com.zl52074.gulimall.seckill.service.impl;
...
import com.zl52074.gulimall.seckill.feign.CouponFeignService;
import com.zl52074.gulimall.seckill.feign.ProductFeignService;
import com.zl52074.gulimall.seckill.interceptor.LoginUserInterceptor;
import com.zl52074.gulimall.seckill.service.SeckillService;
import com.zl52074.gulimall.seckill.to.SeckillSkuRedisTo;
import com.zl52074.gulimall.seckill.vo.SeckillSessionWithSkusVo;
import com.zl52074.gulimall.seckill.vo.SkuInfoVo;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    private void saveSessionInfos(List<SeckillSessionWithSkusVo> sessions) {
        ...
        sessions.stream().forEach(session -> {
            ...
            if (!hasKey) {
                //获取到活动中所有商品的skuId
                //skuId使用前缀区分不同活动 sessionId_skuId
