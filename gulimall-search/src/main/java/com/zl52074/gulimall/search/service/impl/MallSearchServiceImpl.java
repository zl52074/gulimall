...
import com.zl52074.gulimall.search.feign.ProductFeignService;
import com.zl52074.gulimall.search.service.MallSearchService;
import com.zl52074.gulimall.search.vo.AttrResponseVo;
import com.zl52074.gulimall.search.vo.CategoryVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    private SearchResult buildSearchResult(SearchResponse response, SearchParam param) {
        ...
        if(!CollectionUtils.isEmpty(param.getBrandId())){
            ...
            if (r.getCode() == 0) {
                List<SearchResult.BrandVo> vos = r.getData("brand",new TypeReference<List<SearchResult.BrandVo>>() {});
                for (SearchResult.BrandVo vo : vos) {
                    SearchResult.NavVo navVo = new SearchResult.NavVo();
                    navVo.setNavName("品牌");
                    navVo.setNavValue(vo.getBrandName());
                    String replace = replaceQueryString(param, vo.getBrandId() + "", "brandId");
                    navVo.setLink("http://search.gulimall.com/list.html?" + replace);
                    navVos.add(navVo);
                }
            }
        ...
        if(param.getCatalog3Id()!=null){
            ...
            if (r.getCode() == 0) {
                ...
                String replace = replaceQueryString(param, category.getCatId() + "", "catalog3Id");
                navVo.setLink("http://search.gulimall.com/list.html?" + replace);
                navVos.add(navVo);
            }
            result.setNavs(navVos);
